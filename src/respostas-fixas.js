...
// Tratamento formal (Caríssimo/a, Sr./Sra., lhe interessa, Gostaria, etc.)

const CATEGORIAS = [
  {
    id: 'saudacao',
    triggers: ['oi', 'olá', 'ola', 'bom dia', 'boa tarde', 'boa noite', 'hey', 'hi', 'hello', 'epa', 'tudo bem'],
    resposta: 'Olá, Caríssimo(a)! 👋 Sou a Zara, Assistente da StreamZone.\nTemos Netflix e Prime Video a preços acessíveis em Angola.\nO que gostaria de ver? 🎬',
  },
  {
    id: 'precos_netflix',
  ...
  },
  {
    ...
    resposta: 'É muito simples! 😊\n1. Escolhe o plano\n2. Faz a transferência e envia o comprovativo\n3. Recebe os dados de acesso em minutos\nQual plano deseja?',
  },
  {
    id: 'dispositivos',
  ...
  },
  {
    ...
    resposta: 'Vou resolver isso já! 🔧\nDiga-me: qual plataforma (Netflix ou Prime) e qual o email da conta?\nVerifico e corrijo em minutos.',
  },
  {
    id: 'senha_errada',
    ...
    resposta: 'Peço desculpa pelo incómodo! 🔑\nVou verificar e enviar-lhe a senha correcta.\nUm momento, por favor!',
  },
  {
    id: 'reembolso',
  ...
  },
  {
    ...
    resposta: 'Peço desculpa pela demora! 🙏\nVou verificar o seu pagamento agora mesmo.\nUm momento, por favor!',
  },
  {
    id: 'quero_comprar',
  ...
  {
    id: 'reserva',
    triggers: ['guardar', 'reservar', 'separar', 'segurar', 'guardar perfil', 'reservar perfil', 'separar perfil', 'guardar pra mim', 'guardar para mim', 'deixa guardado', 'pode guardar'],
    resposta: 'Posso reservar o seu perfil por 24 horas enquanto faz o pagamento. 📋\nApós esse prazo, fica disponível para outros clientes.\nGostaria que reserve?',
  },
  {
    id: 'site',
    triggers: ['site', 'link', 'website', 'onde compro', 'comprar online'],
    resposta: 'Pode comprar no nosso site! 🌐\nhttps://streamzone-frontend.vercel.app\nOu faço tudo por aqui. O que prefere?',
  },
  {
    id: 'despedida',
