...
module.exports = {
  ...
  slug: 'teste-qa',
  botName: 'juju',
  businessName: 'Teste QA',
  evolutionInstance: 'teste-qa',
  supervisors: ['2449111111'],
  waNumber: '244900000000',
  ...
  identity: {
    ...
    businessName: 'Teste QA',
    niche: 'generico',
    greeting: `Olá! Sou juju, assistente da Teste QA 👋\n\nComo posso ajudar?\n1️⃣ Informações\n2️⃣ Serviços / Produtos\n3️⃣ Horário\n4️⃣ Localização\n5️⃣ Contacto\n0️⃣ Falar com atendente`,
  },
  ...
  fixedResponses: {
    saudacao: `Olá! Bem-vindo à Teste QA 👋\n\nSou juju, aqui para ajudar!\n\n1️⃣ Informações gerais\n2️⃣ Os nossos serviços\n3️⃣ Horário\n4️⃣ Localização\n0️⃣ Falar com a equipa`,
    despedida: 'Obrigado pelo contacto! Até à próxima. A Teste QA está sempre disponível para ajudar. 👋',
    informacao: 'Estou aqui para responder às tuas questões sobre a Teste QA. O que precisas de saber?',
